...
import {administrationNavigation} from 'app/mock-api/common/navigation/data';
...
export class SearchMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._fuseNavigationService.getFlatNavigation(this._administrationNavigation);
