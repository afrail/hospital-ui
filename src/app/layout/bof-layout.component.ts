...
import {AppConfig, Scheme, Theme} from '../main/core/config/app.config';

@Component({
    selector     : 'layout',
    template  : `<bof-menu-layout *ngIf="layout === 'classy'"></bof-menu-layout>`,
    styleUrls    : ['./layout.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class BofLayoutComponent implements OnInit, OnDestroy
{
    config: AppConfig;
    layout: Layout;
    scheme: 'dark' | 'light';
